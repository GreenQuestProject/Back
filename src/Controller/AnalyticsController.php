...
{
    public function __construct(private readonly ProgressionRepository      $progressions,
                                private readonly ProgressionEventRepository $events,
    ...
    public function cohorts(Request $req): JsonResponse
    {
        ...
        $signupWeek = $this->users->signupsByWeek($from, $to);
        $activeWeeks = $this->progressions->activeWeeksByUser($from, $to);
